...
| [M336-103](M336-103-monotonic-guide-rank-plateau.md) | Critical | Mitigated | Monotonic rank finds a plateau and proves its rank-12 HPWL layer closed |
...
| [M336-111](M336-111-grid005-fifth-pair-improvement.md) | Critical | Mitigated | Fifth 0.05 mm pair scan improves certified HPWL by 0.999893 |
| [M336-112](M336-112-grid005-sixth-pair-improvement.md) | Critical | Mitigated | Sixth 0.05 mm pair scan improves certified HPWL by 0.999893 |
...
| [M336-194](M336-194-paired-production-runtime-evidence.md) | Critical | Open | N7 remains pre-effect: the original GPU-2 artifacts are preserved and a deterministic 0-7 scan finds no H100 without foreign compute processes |
