...
| [M336-184](M336-184-exact-guard-revalidates-contact-bytes.md) | Critical | Open | Exact contact and accepted-step guard repeat proposal/final validation on byte-identical coordinates |
