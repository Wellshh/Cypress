...
| [M336-193](M336-193-option1-production-contact-policy.md) | Critical | Open | Option 1 preserves M336-192 as strict reference and restores M336-174 consensus as the production per-step policy |
