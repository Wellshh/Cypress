...
| [M336-176](M336-176-rigid-contact-consensus-exceeds-minimum-rollback-cover.md) | Critical | Open | Every D1/D2 proposal has a smaller graph-cover rollback bound; exact-closure effect remains untested |
