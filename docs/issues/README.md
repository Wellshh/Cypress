...
| [M336-049](M336-049-fixed-domain-region-coordinate-descent.md) | Critical | Mitigated | Single-site fixed domains enable legal regional HPWL descent; two sweeps improve by 1,944.440 |
