...
| [M336-194](M336-194-paired-production-runtime-evidence.md) | Critical | Open | N7 preflight stops environment-incomplete before any arm because GPU 2 retains foreign compute processes |
