...
| [M336-049](M336-049-fixed-domain-region-coordinate-descent.md) | Critical | Mitigated | Single-site fixed domains enable legal regional HPWL descent; three stages improve by 1,103.883 |
