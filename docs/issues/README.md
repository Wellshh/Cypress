...
| [M336-177](M336-177-origin-rollback-recaptures-contact-scope.md) | Critical | Open | Bounded proposal-authority projection passes installed tests; scale-1 D1 still requires implementation push-pull |
